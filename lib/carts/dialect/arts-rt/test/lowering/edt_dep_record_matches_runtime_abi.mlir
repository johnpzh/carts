// RUN: %carts-compile %s --arts-config %arts_config --start-from pre-lowering --pipeline arts-rt-to-llvm | %FileCheck %s --implicit-check-not='!llvm.struct<(i64, ptr, i32, i32, i64, i64)>'

// The depv record type must mirror the v2 runtime arts_edt_dep_t
// {guid, ptr, mode} (24-byte array stride). A wider record makes every
// depv[i>0] access in an EDT read past the runtime's real entries.

// CHECK-LABEL: func.func private @__arts_edt
// CHECK: llvm.getelementptr {{.*}} -> !llvm.ptr, !llvm.struct<(i64, ptr, i32)>

module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi64>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i64>>, llvm.data_layout = "e-m:e-i8:8:32-i16:16:32-i64:64-i128:128-n32:64-S128", llvm.target_triple = "aarch64-unknown-linux-gnu"} {
  func.func @edt_dep_record(%lane: index, %n: index) {
